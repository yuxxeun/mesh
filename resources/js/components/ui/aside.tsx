...
const Item = <T extends object>({ isCurrent, children, className, icon: Icon, ...props }: ItemProps<T>) => {
            ...
            {(values) => (
                <div className="flex items-center gap-2">
                    <>
                        ...
                        <TouchTarget>{typeof children === 'function' ? children(values) : children}</TouchTarget>
                        {props.badge && (
